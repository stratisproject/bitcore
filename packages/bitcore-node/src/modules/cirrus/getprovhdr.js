 ...
 * @constructor
 */
function GetProvheadersMessage(arg, options) {
  Message.call(this, options);
  this.command = 'getprovhdr';
...
inherits(GetProvheadersMessage, Message);

GetProvheadersMessage.prototype.setPayload = function(payload) {
...
module.exports = GetProvheadersMessage;